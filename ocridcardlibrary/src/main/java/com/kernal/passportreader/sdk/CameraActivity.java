...
public class CameraActivity extends Activity implements SurfaceHolder.Callback,
    ...
    private String picPathString = PATH + "zkbhIDCard.jpg";
...
//        imbtn_takepic.setOnClickListener(this); // 屏蔽 2018/8/31
...
//        imbtn_eject.setOnClickListener(this); // 屏蔽 2018/8/3
//        imbtn_eject.setVisibility(View.VISIBLE); // 屏蔽 2018/8/3
...
//            name = pictureName();
            // updata code 2018/8/23
            name = pictureNameZkbh();
            picPathString1 = PATH + "Android_zkbhIDCard_" + name + "_full.jpg";
            picPathString = PATH + "Android_zkbhIDCard_" + name + "Cut.jpg";
            isTouched = true;
            mAutoFocusHandler.removeMessages(100);
...
//								 size.width, size.height);
    ...
    private String pictureNameZkbh() {
...
//            rpm.lpHeadFileName = "";//  save document protrait
            // update code 2018/08/23修改存储裁剪头像路径
...
//                Intent intent = new Intent("kernal.idcard.ShowResultActivity");
                Intent intent = new Intent("biomhope.idcard.OcrResultActivity");
                ...
                intent.putExtra("HeadJpgPath", HeadJpgPath);
...
//                startActivity(intent);
                ...
                RecogResultBean resultBean = new RecogResultBean();
                resultBean.recogResultString = recogResultString;
                resultBean.HeadJpgPath = HeadJpgPath;
